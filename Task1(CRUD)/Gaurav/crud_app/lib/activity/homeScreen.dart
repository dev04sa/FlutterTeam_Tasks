...
class HomeScreen extends StatelessWidget {
            ...
            child: Column(
              children: [
                ...
                ValueListenableBuilder(valueListenable: _studentview
                    , builder: (context, _isstudentview, child){
                  return _isstudentview ? _displayData(context): _blankview(context);
                    }),
                const SizedBox(height: 24,),
              ],
            ),
          ...
          builder: (context, snapshot){
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index){
                StudentData _student = students[index].data();
                String _studentdocId = students[index].id;

                return InkWell(
                  onTap: (){
                    _editStudentInfo(context, _studentdocId, _student);
                  },
                  child: Card(
                    ...
                    child: ListTile(
                      title: Row(
                        ...
                        children: [
                          ...
                          Text(_student.studentId.toString()),
                          Text(_student.studentProgram),
                          Text(_student.cgpa.toString())
                        ],
                      ),
                    ),
                  ),
  ...
  void _editStudentInfo(BuildContext context, String _studentdocId, StudentData _student){
    _namecontroller.text = _student.name;
    _studentIdcontroller.text = _student.studentId.toString();
    _studentProgramcontroller.text = _student.studentProgram;
    _cgpacontroller.text = _student.cgpa.toString();
    _docId.value = _studentdocId;
  }
