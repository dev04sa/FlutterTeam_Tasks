...
class ChatMessage extends StatelessWidget {
  ChatMessage({super.key, this.text, this.image, required this.time, required this.ifUser});
  final String? text;
  final String time;
  final File? image;
  final bool ifUser;
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              CircleAvatar(backgroundImage: AssetImage(ifUser? "assets/user.png":"assets/Designer.png"),),
                ...
                children: [
                  ...
                  if (text != null)
                    Container(
                      ...
                      padding: EdgeInsets.only(top: 15, left: 15, right: 20, bottom: 5),
                  ...
                  if (image != null)SizedBox(height: 15,),
